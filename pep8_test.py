"""get OS functionalities and performs unittests"""
import os
import unittest


def pwd() -> str:
    """a function that prints current working directory"""
    print("\n Working directory is: " + os.getcwd())


class TestPWD(unittest.TestCase):
    """A class that inherits unittest TestCase class"""

    def test_pwd(self):
        """a method that tests for working directory using unittest"""
        self.assertNotEqual(pwd(), "")


def assert_test_pwd() -> str:
    """a function that tests for working directory using assert"""
    assert pwd() != ""
